...
import {
    getFirestore, collection, addDoc, onSnapshot, updateDoc, doc, query, orderBy
...
async function salvarCrianca(e) {
    ...
    if (editandoId) {
        ...
        await addDoc(collection(db, "criancas"), { nome, idade, responsavel, telefone, alergias, banheiroSozinho: banheiro, pulseira, historico: [] });
    }
